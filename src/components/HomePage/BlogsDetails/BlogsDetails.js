...
const BlogsDetails = (props) => {
    const {imageUpload,contentTitle,Description} = props.content;
    return (
        <article class="flex flex-col shadow my-4">
        {/* article image */}
        <img src={imageUpload} alt="" className="md:w-full object-cover object-center" />
        <div class="bg-white flex flex-col justify-start p-6">
            <h5 class="text-blue-700 text-sm font-bold uppercase pb-4">Technology</h5>
            <h2 class="text-3xl font-bold hover:text-gray-700 pb-4">{contentTitle}</h2>
